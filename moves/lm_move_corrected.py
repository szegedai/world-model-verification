...
def lm_move_corrected(board: Board,
                      game_prefix: str,
                      move_number: int,
                      model: ChessLM,
    ...
    return chess_lm_move_corrected(model,
                                   tokenizer,
...
def chess_lm_move_corrected(model: ChessLM,
                            tokenizer: ChessTokenizer,
    ...
    for idx in range(3):
        ...
        sorted_tokens = torch.argsort(last_token_logit, descending=True)
