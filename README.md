...
### Checkpoints
The checkpoints (weights) of our **48 models**, as well as the checkpoints of the board state probes are available on HuggingFace: [https://huggingface.co/Erasiel/chess-models](https://huggingface.co/Erasiel/chess-models).

### Datasets
The datasets used in our experiments are available on HuggingFace: [https://huggingface.co/datasets/Erasiel/chess-datasets](https://huggingface.co/datasets/Erasiel/chess-datasets)
